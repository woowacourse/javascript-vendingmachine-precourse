...
export const ZEOR_ERROR = 'zero-error';
export const SOIDOUT_ERROR = 'soldout-error';
export const NO_MONEY_ERROR = 'nomoney-error';
...
export const ALERT_MSG = {
  ...
  'zero-error': '0은 입력하실 수 없습니다 다시 입력해주세요',
  'soldout-error': '해당 상품은 품절되었습니다 다음에 구매해주세요',
  'nomoney-error': '투입한 금액을 초과합니다 다음에 구매해주세요',
};
