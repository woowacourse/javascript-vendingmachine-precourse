...
export const INPUT_CHANGES_CHARGE_CHARGE_AMOUNT_RULE_VIOLATED =
  'INPUT_CHANGES_CHARGE_CHARGE_AMOUNT_RULE_VIOLATED';
export const INPUT_PRODUCT_PURCHASE_CHARGE_AMOUNT_RULE_VIOLATED =
  'INPUT_PRODUCT_PURCHASE_CHARGE_AMOUNT_RULE_VIOLATED';
...
const errorMessagesRecord = {
  ...
  [INPUT_CHANGES_CHARGE_CHARGE_AMOUNT_RULE_VIOLATED]:
    '입력된 잔돈 충전액은 동전들로 구성할 수 없는 금액입니다.',
  [INPUT_PRODUCT_PURCHASE_CHARGE_AMOUNT_RULE_VIOLATED]: `투입 금액은 ${COINS_PRICE_MIN}원으로 나누어 떨어져야 합니다.`,
