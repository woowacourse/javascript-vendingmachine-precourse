...
export const ID = Object.freeze({
  ...
  PRODUCT_MANAGE_FORM: 'product-manage-form',
  PRODUCT_MANAGE_TABLE_CONTAINER: 'product-manage-table-container',
  ...
  VENDING_MACHINE_TABLE_CONTAINER: 'vending-machine-table-container',
  VENDING_MACHINE_CHARGE_FORM: 'vending-machine-charge-form',
  CHARGE_INPUT: 'charge-input',
  CHARGE_AMOUNT: 'charge-amount',
  CHARGE_BUTTON: 'charge-button',
  PRODUCT_TABLE_CONTAINER: 'product-table-container',
  PURCHASE_CHARGE_TABLE_CONTAINER: 'purchase-charge-table-container',
  PURCHASE_CHARGE_FORM: 'purchase-charge-form',
