  ...
  return `
    ...
    <section>
      ...
      <table id=${ID.COIN_RETURN_TABLE}>
        ...
        <tr>
          <th>500원</th>
          <td  id=${ID.COIN_500_QUANTITY}>${coinList['500']}개</td>
        </tr>
        <tr>
          <th>100원</th>
          <td id=${ID.COIN_100_QUANTITY}>${coinList['100']}개</td>
        </tr>
        <tr>
          <th>50원</th>
          <td id=${ID.COIN_50_QUANTITY}>${coinList['50']}개</td>
        </tr>
        <tr>
          <th>10원</th>
          <td id=${ID.COIN_10_QUANTITY}>${coinList['10']}개</td>
        </tr>
      </table>
    </section>
`;
...
export const getCoinReturnListTemplate = (coinList) => {
  return `
    ...
    <tr>
      <th id=${ID.COIN_500_QUANTITY}>500원</th>
      <td>${coinList['500']}개</td>
    </tr>
    <tr>
      <th id=${ID.COIN_100_QUANTITY}>100원</th>
      <td>${coinList['100']}개</td>
    </tr>
    <tr>
      <th id=${ID.COIN_50_QUANTITY}>50원</th>
      <td>${coinList['50']}개</td>
    </tr>
    <tr>
      <th id=${ID.COIN_10_QUANTITY}>10원</th>
      <td>${coinList['10']}개</td>
    </tr>
  `;
};
