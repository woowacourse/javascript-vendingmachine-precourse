...
export const COIN_TITLE = '동전';
export const COIN_AMOUNT_TITLE = '개수';
export const TITLE_500 = '500원';
export const TITLE_100 = '100원';
export const TITLE_50 = '50원';
export const TITLE_10 = '10원';
export const PRODUCT_ADD_TITLE = '상품 추가하기';
export const PRODUCT_LIST_TITLE = '상품 현황';
export const PRODUCT_NAME_TITLE = '상품명';
export const PRODUCT_PRICE_TITLE = '가격';
export const PRODUCT_QUANTITY_TITLE = '수량';
export const PURCHASE_INPUT_TITLE = '금액 투입';
export const PURCHASE_INPUT_PLACEHOLDER_TITLE = '투입할 금액';
export const PURCHASE_INPUT_BUTTON_TITLE = '투입하기';
export const PURCHASE_INPUT_SPAN_TITLE = '투입한 금액';
export const PURCHASE_PRODUCTS_LIST_TITLE = '구매할 수 있는 상품 현황';
export const PURCHASE_PRODUCT_BUY_TITLE = '구매';
export const PURCHASE_CHANGE_TITLE = '잔돈';
export const PURCHASE_RETURN_TITLE = '반환하기';
export const PURCHASE_PRODUCT_BUTTON_TITLE = '구매하기';

export const PRODUCT_ADD_TAB_TITLE = '상품 관리';
...
export const CHARGE_500_QUANTITY_ID = 'vending-machine-coin-500-quantity';
...
export const PURCHASE_INPUT_ID = 'charge-input';
export const PURCHASE_BUTTON_ID = 'charge-button';
export const PURCHASE_AMOUNT_ID = 'charge-amount';
export const PURCHASE_500_QUANTITY_ID = 'coin-500-quantity';
export const PURCHASE_100_QUANTITY_ID = 'coin-100-quantity';
export const PURCHASE_50_QUANTITY_ID = 'coin-50-quantity';
export const PURCHASE_10_QUANTITY_ID = 'coin-10-quantity';
export const PURCHASE_ITEM_CLASS = 'product-purchase-item';
export const PURCHASE_BUY_BUTTON_CLASS = 'purchase-button';
...
export const PURCHASE_CONTAINER_ID = 'purchase-container';
