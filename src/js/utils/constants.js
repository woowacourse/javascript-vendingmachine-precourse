export const ERROR = {
  NAME_BLANK: '상품명이 공백입니다. 다시 입력하세요❗️',
  PRICE_BLANK: '가격을 입력하지 않았습니다. 다시 입력하세요❗️',
  PRICE_TOO_LOW: '상품 가격은 100원 이상만 입력 가능합니다. 다시 입력하세요❗️',
  PRICE_SHOULD_DIVIDED_INTO_TEN: '상품 가격은 10원으로 나눠져야합니다. 다시 입력하세요❗️',
  QUANTITY_BLANK: '수량이 입력되지 않았습니다. 다시 입력하세요❗️',
