...
- [ ] 4. 상품이 추가되면 동적으로 화면에 표시
- [ ] 5. Storage 기능 확장(subscribe, notify 추가)
...
- 상품 추가 시 유효성 검사를 진행합니다.
  - [ ] 상품명은 최대 20자까지 등록하도록 합니다.
  - [ ] 상품명의 앞, 뒤 공백은 제거됩니다.
  - [ ] 상품명은 중복 등록될 수 없습니다.
  - [ ] 가격은 양의 정수만 입력됩니다.
  - [ ] 가격은 100 이상, 10으로 나누어 떨어지는 정수입니다.
  - [ ] 수량은 양의 정수만 입력됩니다.
  - [ ] 상품명, 가격, 수량은 공백일 수 없습니다.
  - [ ] 상품명, 가격, 수량의 잘못된 입력값에 대해 alert을 출력하고 값을 비운 뒤 포커싱합니다.
