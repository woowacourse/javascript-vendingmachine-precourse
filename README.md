...
### 1) 탭 메뉴 구현하기
- 버튼 클릭 시, 해당 탭을 이동한다. ✔️
- 상품 관리 ✔️
- 잔돈 충전 ✔️
- 상품 구매 ✔️

### 2) 상품 관리 탭
- 자판기에 상품명, 가격, 수량 정보를 추가하는 기능을 구현 ✔️
  - 상품명이 중복되지 않는지 검증해야 한다. ✔️
  - 가격과 수량이 0 이상인지 검증해야 한다. ✔️
  - 상품 추가 시, 상품을 화면에 보여준다. ✔️

### 3) 잔돈 충전 탭
- 자판기에 동전을 충전하는 기능을 구현 ✔️
  - 동전이 10원 이상인지 검증해야 한다. ✔️
  - 동전이 10원 단위로 나눠지는지 검증해야 한다. ✔️
  - 잔돈 충전 시, 추가된 동전을 화면에 보여준다. ✔️
  - 잔돈 충전 시, 자판기가 보유하고 있는 총 금액을 화면에 보여준다. ✔️

### 4) 상품 구매 탭
- 자판기에 금액을 투입하는 기능을 구현 ✔️
  - 금액이 0 이상인지 검증해야 한다. ✔️
  - 투입한 금액을 화면에 보여준다. ✔️
- 자판기에 있는 상품을 구매하는 기능을 구현
  - 구매할 수 있는 상품을 화면에 보여준다. ✔️
  - 구매 시, 투입된 금액과 상품 수량을 감소시킨다. ✔️
  - 구매 시, 투입한 금액이 가격보다 크거나 같은 지 검증한다. ✔️
  - 구매 후, 변경된 상품 현황을 화면에 보여준다. ✔️
  - 구매 후, 변경된 투입 금액을 화면에 보여준다. ✔️
- 잔돈을 반환하는 기능 구현 ✔️
